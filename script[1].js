...
// Decode any HTML entities (e.g. "Services &amp; Pricing") before splitting
// into per-character spans below — otherwise entities get torn apart into
// separate spans and render as literal text like "&amp;" instead of "&".
...
document.querySelectorAll('.section-title').forEach(title => {
  ...
  title.innerHTML = lines.map(line =>
    decodeEntities(line).split('').map((ch, i) =>
